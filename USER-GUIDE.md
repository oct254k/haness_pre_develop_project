...
│   ├── api-spec.md             ← API 스펙
│   └── interface-spec.md       ← 외부 시스템 인터페이스 (IF-ID)
├── 04_design/
